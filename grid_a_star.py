"""
Created on Wed May 13 10:25:21 2020
grid_a_star
@author: cjzhang
"""
import math
    ...
    while 1:
        ...
        for i in range(nmotion): # expand search grid based on motion model
            ...
            if verify_node(node, minx, miny, xw, yw, obmap) == False:
                continue
            #Jump out of this cycle when node is out of range
...
def calc_obstacle_map(ox, oy, reso, vr):
    ...
    obmap = [[0 for i in range(int(ywidth))] for i in range(int(xwidth))]
